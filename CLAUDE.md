...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type":"ListItem","position":3,"name":"POST TITLE HERE","item":"https://www.positionxero.com/blog/POST-SLUG.html"}
  ]
}
</script>
```
...
- The position-3 `item` URL must **exactly** equal the page's `rel="canonical"` href — same slug, `.html` extension, `https://www.positionxero.com` host with `www`.
